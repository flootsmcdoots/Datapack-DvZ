...
tag @s add dvz.dwarf
tag @s add dvz.dwarf.class
tag @s add dvz.dwarf.class.hero
tag @s add dvz.dwarf.class.hero.assassin_slayer
tag @s add dvz.mana
...
item replace entity @s armor.head with minecraft:chainmail_helmet[ \
  ...
  minecraft:attribute_modifiers=[ \
    {type:"minecraft:armor",amount:3,operation:"add_value",slot:"head",id:"dvz:head"}, \
    {type:"minecraft:armor_toughness",amount:2,operation:"add_value",slot:"head",id:"dvz:head"} \
  ] \
]
...
item replace entity @s armor.chest with minecraft:chainmail_chestplate[ \
  ...
  minecraft:attribute_modifiers=[ \
    {type:"minecraft:armor",amount:8,operation:"add_value",slot:"chest",id:"dvz:chest"}, \
    {type:"minecraft:armor_toughness",amount:2,operation:"add_value",slot:"chest",id:"dvz:chest"} \
  ] \
]
...
item replace entity @s armor.legs with minecraft:chainmail_leggings[ \
  ...
  minecraft:attribute_modifiers=[ \
    {type:"minecraft:armor",amount:6,operation:"add_value",slot:"legs",id:"dvz:legs"}, \
    {type:"minecraft:armor_toughness",amount:2,operation:"add_value",slot:"legs",id:"dvz:legs"} \
  ] \
]
...
item replace entity @s armor.feet with minecraft:chainmail_boots[ \
  ...
  minecraft:attribute_modifiers=[ \
    {type:"minecraft:armor",amount:3,operation:"add_value",slot:"feet",id:"dvz:feet"}, \
    {type:"minecraft:armor_toughness",amount:2,operation:"add_value",slot:"feet",id:"dvz:feet"}, \
    {type:"minecraft:movement_speed",amount:0.2,operation:"add_multiplied_total",slot:"feet",id:"dvz:feet"} \
  ] \
]
...
give @s minecraft:carrot_on_a_stick[ \
  ...
  minecraft:item_model="dvz:betrayers_dagger", \
  minecraft:lore=[ \
  ...
  minecraft:unbreakable={}, \
  minecraft:tooltip_style="dvz:legendary", \
...
give @s minecraft:carrot_on_a_stick[ \
  ...
  minecraft:item_model="dvz:cloak_of_shadows", \
  minecraft:unbreakable={}, \
  minecraft:tooltip_style="dvz:legendary", \
...
give @s minecraft:carrot_on_a_stick[ \
  ...
  minecraft:item_model="dvz:mana_star", \
  minecraft:unbreakable={}, \
  minecraft:tooltip_style="dvz:legendary", \
