...
tag @s add dvz.dwarf.class.hero.dragon_warrior
tag @s add dvz.mana
...
give @s minecraft:carrot_on_a_stick[ \
  ...
  minecraft:item_model="dvz:golden_flail", \
  minecraft:lore=[ \
...
give @s minecraft:carrot_on_a_stick[ \
  ...
  minecraft:item_model="dvz:dragon_scale", \
  minecraft:unbreakable={}, \
  minecraft:tooltip_style="dvz:legendary", \
...
give @s minecraft:carrot_on_a_stick[ \
  ...
  minecraft:item_model="dvz:dwarven_ruby", \
  minecraft:unbreakable={}, \
  minecraft:tooltip_style="dvz:legendary", \
