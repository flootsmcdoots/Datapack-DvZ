...
tag @s add dvz.dwarf.class.hero.dwarven_guard
tag @s add dvz.mana
...
give @s minecraft:carrot_on_a_stick[ \
  ...
  minecraft:item_model="dvz:elder_guardian_eye", \
  minecraft:unbreakable={}, \
...
give @s minecraft:carrot_on_a_stick[ \
  ...
  minecraft:item_model="dvz:oceans_pearl", \
  minecraft:unbreakable={}, \
  minecraft:tooltip_style="dvz:legendary", \
...
give @s minecraft:carrot_on_a_stick[ \
  ...
  minecraft:item_model="dvz:glowing_shell", \
  minecraft:unbreakable={}, \
  minecraft:tooltip_style="dvz:legendary", \
