...
tag @s add dvz.dwarf.class.builder
tag @s add dvz.mana
...
item replace entity @s weapon.offhand with minecraft:poisonous_potato[ \
  minecraft:item_model="dvz:crab_claw", \
  !minecraft:food, \
...
give @s minecraft:carrot_on_a_stick[ \
  ...
  minecraft:item_model="dvz:summoning_book_builder", \
...
give @s minecraft:iron_shovel[ \
  ...
  minecraft:item_model="dvz:iron_paxel", \
  minecraft:enchantments={ \
...
# Legendary Book
execute as @s at @s run function dvz:give/other/legendary_book

# Volunteer books
execute as @s at @s run function dvz:give/other/volunteer_book
execute as @s at @s run function dvz:give/other/hero_volunteer_book
...
function dvz:misc/doom_event_message
