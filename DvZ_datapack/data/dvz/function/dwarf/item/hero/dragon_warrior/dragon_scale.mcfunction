...
execute if entity @s[scores={dvz.dragon_warrior.dragon_scale.cooldown.seconds=1..}] run title @s actionbar [ \
  "", \
  {text:"[Dragon Scale]",bold:true,color:"red"}, \
  {text:" You have ",color:"red"}, \
  {"score":{"name":"@s","objective":"dvz.dragon_warrior.dragon_scale.cooldown.seconds"},bold:true,color:"red"}, \
  {text:" seconds remaining!",color:"red"} \
]
execute if entity @s[scores={dvz.dragon_warrior.dragon_scale.cooldown.seconds=1..}] run return 0
...
tag @s add dvz.dwarf.class.hero.dragon_warrior.dragon_form
...
attribute @s minecraft:attack_damage modifier add dvz:dragon_form.attack_damage 3 add_value
attribute @s minecraft:movement_speed modifier add dvz:dragon_form.movement_speed 0.2 add_multiplied_total

# Add wings to the chestplate and let dragon warrior glide with them.
item modify entity @s armor.chest dvz:dragon_warrior_dragon_form_chestplate
