...
# Set the cooldown.
scoreboard players set @s dvz.dragon_warrior.dragon_scale.cooldown.seconds 300
...
item modify entity @s armor.chest dvz:dragon_warrior_normal_form_chestplate
