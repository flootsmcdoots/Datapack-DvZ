...
execute as @s[scores={dvz.marker.glowing_shell.duration.ticks=1..}] run return 0
...
execute store result score @s temp.duration.seconds run scoreboard players get @s dvz.marker.glowing_shell.duration.seconds
