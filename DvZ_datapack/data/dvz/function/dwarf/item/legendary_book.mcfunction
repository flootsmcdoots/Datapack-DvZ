...
execute as @s[tag=dvz.dwarf.class.builder] run loot give @s loot dvz:dwarf/legendary_book/builder
execute as @s[tag=dvz.dwarf.class.blacksmith] run loot give @s loot dvz:dwarf/legendary_book/blacksmith
execute as @s[tag=dvz.dwarf.class.tailor] run loot give @s loot dvz:dwarf/legendary_book/tailor
execute as @s[tag=dvz.dwarf.class.baker] run loot give @s loot dvz:dwarf/legendary_book/baker
execute as @s[tag=dvz.dwarf.class.alchemist] run loot give @s loot dvz:dwarf/legendary_book/alchemist
execute as @s[tag=dvz.dwarf.class.enchanter] run loot give @s loot dvz:dwarf/legendary_book/enchanter
