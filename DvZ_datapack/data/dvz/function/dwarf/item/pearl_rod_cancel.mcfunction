...
advancement revoke @s only dvz:misc/player_hurt_while_teleporting_pearl_rod
...
scoreboard players set @s dvz.dwarf.pearl_rod.warmup.seconds 0
scoreboard players set @s dvz.dwarf.pearl_rod.warmup.ticks 0
