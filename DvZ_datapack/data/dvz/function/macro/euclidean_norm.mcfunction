...
execute store result storage dvz:euclidean norm float 1 run data get entity @n[type=minecraft:block_display,tag=temp.euclidean_norm] transformation.scale[0]
