...
tag @s add dvz.zombie.class.chicken_nugget

# Multiply movement speed by 1.4, increase jump strength by 0.2 and nullify fall damage using attributes.
attribute @s minecraft:movement_speed modifier add dvz:chicken_nugget.movement_speed 0.4 add_multiplied_total
attribute @s minecraft:jump_strength modifier add dvz:chicken_nugget.jump_strength 0.2 add_value
attribute @s minecraft:fall_damage_multiplier modifier add dvz:chicken_nugget.fall_damage_multiplier -1.0 add_multiplied_total
...
item replace entity @s armor.head with minecraft:leather_helmet[ \
  ...
  minecraft:item_model="dvz:chicken_nugget_head", \
...
# Boots
# removed enchantment: "dvz:midair_jump":3
...
give @s minecraft:carrot_on_a_stick[ \
  ...
  minecraft:item_model="dvz:eggsplosive_egg", \
  minecraft:unbreakable={}, \
...
give @s minecraft:carrot_on_a_stick[ \
  ...
  minecraft:item_model="dvz:flutter", \
  minecraft:unbreakable={}, \
