...
tag @s add dvz.zombie.class.silverfish

# Multiply movement speed by 1.2 using an attribute.
attribute @s minecraft:movement_speed modifier add dvz:silverfish.movement_speed 0.2 add_multiplied_total

# Set the silverfish egg bar to 10.
scoreboard players set @s dvz.silverfish.silverfish_egg.count 10
...
item replace entity @s armor.head with minecraft:leather_helmet[ \
  ...
  minecraft:item_model="dvz:silverfish_head", \
...
give @s minecraft:carrot_on_a_stick[ \
  ...
  minecraft:item_model="dvz:infest", \
  minecraft:unbreakable={}, \
...
give @s minecraft:iron_shovel[ \
  ...
  minecraft:attribute_modifiers=[ \
    {type:"minecraft:attack_damage",amount:0.0,operation:"add_value",slot:"mainhand",id:"dvz:mainhand"}, \
    {type:"minecraft:attack_speed",amount:-3.0,operation:"add_value",slot:"mainhand",id:"dvz:mainhand"} \
  ], \
  minecraft:tooltip_display={ \
    hidden_components:[ \
      "minecraft:unbreakable", \
