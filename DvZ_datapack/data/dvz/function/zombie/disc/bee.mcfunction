...
tag @s add dvz.zombie.class.bee

# Decrease health by 2 hearts and nullify fall damage using attributes.
attribute @s minecraft:max_health modifier add dvz:bee.max_health -4 add_value
attribute @s minecraft:fall_damage_multiplier modifier add dvz:bee.fall_damage_multiplier -1.0 add_multiplied_total
...
item replace entity @s armor.head with minecraft:leather_helmet[ \
  ...
  minecraft:item_model="dvz:bee_head", \
...
give @s minecraft:carrot_on_a_stick[ \
  ...
  minecraft:item_model="dvz:honey", \
  minecraft:unbreakable={}, \
...
give @s minecraft:carrot_on_a_stick[ \
  ...
  minecraft:item_model="dvz:hover_disabled", \
  minecraft:unbreakable={}, \
