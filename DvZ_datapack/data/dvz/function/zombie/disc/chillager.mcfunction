...
tag @s add dvz.zombie.class.chillager

# Give the player the ice element tag.
tag @s add dvz.zombie.element.ice

# Multiply movement speed by 1.4, increase jump strength by 0.3 and increase safe fall distance by 6 using attributes.
attribute @s minecraft:movement_speed modifier add dvz:chillager.movement_speed 0.4 add_multiplied_total
attribute @s minecraft:jump_strength modifier add dvz:chillager.jump_strength 0.3 add_value
attribute @s minecraft:safe_fall_distance modifier add dvz:chillager.safe_fall_distance 6.0 add_value

# Fill the invisibility bar.
scoreboard players set @s dvz.chillager.invisibility.duration 1200
...
item replace entity @s armor.head with minecraft:leather_helmet[ \
  ...
  minecraft:item_model="dvz:chillager_head", \
  ...
  minecraft:attribute_modifiers=[ \
    {type:"minecraft:armor",amount:1,operation:"add_value",slot:"head",id:"dvz:head"} \
  ], \
...
item replace entity @s armor.chest with minecraft:leather_chestplate[ \
  ...
  minecraft:attribute_modifiers=[ \
    {type:"minecraft:armor",amount:3,operation:"add_value",slot:"chest",id:"dvz:chest"} \    
  ], \
  minecraft:tooltip_display={ \
    hidden_components:[ \
...
item replace entity @s armor.legs with minecraft:leather_leggings[ \
  ...
  minecraft:attribute_modifiers=[ \
    {type:"minecraft:armor",amount:2,operation:"add_value",slot:"legs",id:"dvz:legs"} \
  ], \
  minecraft:tooltip_display={ \
    hidden_components:[ \
      "minecraft:dyed_color" \
...
give @s minecraft:music_disc_13[ \
  ...
  minecraft:item_model="dvz:shiver", \
  minecraft:enchantments={"dvz:chilling_backstab":1,"knockback":2}, \
  minecraft:lore=[ \
    {text:" "}, \
...
give @s minecraft:carrot_on_a_stick[ \
  ...
  minecraft:item_model="dvz:invisibility", \
  minecraft:unbreakable={}, \
...
give @s minecraft:carrot_on_a_stick[ \
  ...
  minecraft:item_model="dvz:ice_bridge", \
  minecraft:unbreakable={}, \
