...
tag @s add dvz.zombie.class.blaze

# Give the player the fire element tag.
tag @s add dvz.zombie.element.fire

# Attribute: immune to fall damage
attribute @s minecraft:fall_damage_multiplier modifier add dvz:blaze.fall_immunity -1 add_value
...
item replace entity @s armor.head with minecraft:leather_helmet[ \
  ...
  minecraft:item_model="dvz:blaze_head", \
...
give @s minecraft:carrot_on_a_stick[ \
  ...
  minecraft:item_model="dvz:fireball", \
  minecraft:unbreakable={}, \
...
give @s minecraft:carrot_on_a_stick[ \
  ...
  minecraft:item_model="dvz:firefly", \
  minecraft:unbreakable={}, \
...
give @s minecraft:carrot_on_a_stick[ \
  ...
  minecraft:item_model="dvz:heat_wave", \
  minecraft:unbreakable={}, \
