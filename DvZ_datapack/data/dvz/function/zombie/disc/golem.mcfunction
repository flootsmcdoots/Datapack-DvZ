...
tag @s add dvz.zombie.class.golem
...
attribute @s minecraft:max_health modifier add dvz:golem.max_health 20.0 add_value
attribute @s minecraft:attack_damage modifier add dvz:golem.attack_damage 999.0 add_multiplied_total
attribute @s minecraft:attack_speed modifier add dvz:golem.attack_speed -0.75 add_multiplied_total
attribute @s minecraft:knockback_resistance modifier add dvz:golem.knockback_resistance 1.0 add_value
attribute @s minecraft:explosion_knockback_resistance modifier add dvz:golem.explosion_knockback_resistance 1.0 add_value
attribute @s minecraft:movement_speed modifier add dvz:golem.movement_speed -0.6 add_multiplied_total
attribute @s minecraft:jump_strength modifier add dvz:golem.jump_strength -1.0 add_multiplied_total
attribute @s minecraft:fall_damage_multiplier modifier add dvz:golem.fall_damage_multiplier -1.0 add_multiplied_total
attribute @s minecraft:mining_efficiency modifier add dvz:golem.mining_efficiency -0.5 add_multiplied_total
...
item replace entity @s armor.head with minecraft:iron_helmet[ \
  ...
  minecraft:item_model="dvz:golem_head", \
...
item replace entity @s armor.chest with minecraft:iron_chestplate[ \
  ...
  minecraft:attribute_modifiers=[ \
    {type:"minecraft:armor",amount:6,operation:"add_value",slot:"chest",id:"dvz:chest"} \    
  ] \
]
# Leggings
item replace entity @s armor.legs with minecraft:iron_leggings[ \
  ...
  minecraft:attribute_modifiers=[ \
    {type:"minecraft:armor",amount:5,operation:"add_value",slot:"legs",id:"dvz:legs"} \
  ] \
]
# Boots
item replace entity @s armor.feet with minecraft:iron_boots[ \
  ...
  minecraft:attribute_modifiers=[ \
    {type:"minecraft:armor",amount:2,operation:"add_value",slot:"feet",id:"dvz:feet"} \
  ] \
]
...
give @s minecraft:carrot_on_a_stick[ \
  ...
  minecraft:item_model="dvz:fissure", \
  minecraft:unbreakable={}, \
...
execute as @a[tag=dvz.joined_game] run playsound minecraft:entity.iron_golem.repair player @s ~ ~512 ~ 1 1 1
