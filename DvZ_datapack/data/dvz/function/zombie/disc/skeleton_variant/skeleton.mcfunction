#> Description: Turns the player into the skeleton.
...
tag @s add dvz.zombie.class.skeleton_variant.skeleton

# Put the player on the skeleton zombie team.
team join z1SKELETON @s

### Equip the player with skeleton armor (chainmail tier).
# Head (Helmet)
item replace entity @s armor.head with minecraft:leather_helmet[ \
  minecraft:unbreakable={}, \
  minecraft:item_name={text:"Skeleton Skull",color:"aqua"}, \
  minecraft:item_model="dvz:skeleton_skull", \
...
### Give the player all the skeleton items.
# Bow
