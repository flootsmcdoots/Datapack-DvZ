...
tag @s add dvz.zombie.class.enderman
...
item replace entity @s armor.head with minecraft:leather_helmet[ \
  ...
  minecraft:item_model="dvz:enderman_head", \
...
give @s minecraft:carrot_on_a_stick[ \
  ...
  minecraft:item_model="dvz:teleport", \
  minecraft:unbreakable={}, \
...
give @s minecraft:carrot_on_a_stick[ \
  ...
  minecraft:item_model="dvz:create_portal", \
  minecraft:unbreakable={}, \
...
execute as @a[tag=dvz.joined_game] run playsound minecraft:entity.enderman.scream player @s ~ ~512 ~ 1 1 1
