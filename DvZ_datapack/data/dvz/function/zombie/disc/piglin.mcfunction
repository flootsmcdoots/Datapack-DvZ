...
tag @s add dvz.zombie.class.piglin

# Multiply movement speed by 1.2 using an attribute.
attribute @s minecraft:movement_speed modifier add dvz:piglin.movement_speed 0.2 add_multiplied_total
...
item replace entity @s armor.head with minecraft:leather_helmet[ \
  ...
  minecraft:item_model="dvz:piglin_head", \
...
give @s minecraft:carrot_on_a_stick[ \
  ...
  minecraft:item_model="dvz:evolution", \
  minecraft:unbreakable={}, \
