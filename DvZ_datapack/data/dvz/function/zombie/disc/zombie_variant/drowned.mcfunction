...
tag @s add dvz.zombie.class.zombie_variant
tag @s add dvz.zombie.class.zombie_variant.drowned
...
item replace entity @s armor.head with minecraft:leather_helmet[ \
  ...
  minecraft:item_model="dvz:drowned_head", \
...
give @s minecraft:trident[ \
  ...
  minecraft:enchantments={"minecraft:riptide":3,knockback:1,sharpness:3}, \
  minecraft:lore=[ \
...
give @s minecraft:carrot_on_a_stick[ \
  ...
  minecraft:item_model="dvz:undying_bond", \
  minecraft:unbreakable={}, \
