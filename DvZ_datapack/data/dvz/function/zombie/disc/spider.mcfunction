...
tag @s add dvz.zombie.class.spider

# Multiply movement speed by 1.6, increase jump strength by 0.5 and increase safe fall distance by 12 using attributes.
attribute @s minecraft:movement_speed modifier add dvz:spider.movement_speed 0.6 add_multiplied_total
attribute @s minecraft:jump_strength modifier add dvz:spider.jump_strength 0.5 add_value
attribute @s minecraft:safe_fall_distance modifier add dvz:spider.safe_fall_distance 12.0 add_value
...
item replace entity @s armor.head with minecraft:leather_helmet[ \
  ...
  minecraft:item_model="dvz:spider_head", \
...
give @s minecraft:stick[ \
  minecraft:item_model="dvz:web_cleaner", \
