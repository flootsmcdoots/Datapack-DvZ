...
tag @s add dvz.zombie.class.ocelot

# Give the player the mana tag.
tag @s add dvz.mana

# Multiply movement speed by 1.4 and nullify fall damage using attributes.
attribute @s minecraft:movement_speed modifier add dvz:ocelot.movement_speed 0.4 add_multiplied_total
attribute @s minecraft:fall_damage_multiplier modifier add dvz:ocelot.fall_damage_multiplier -1.0 add_multiplied_total
...
item replace entity @s armor.head with minecraft:leather_helmet[ \
  ...
  minecraft:item_model="dvz:ocelot_head", \
...
give @s minecraft:carrot_on_a_stick[ \
  ...
  minecraft:item_model="dvz:slapper_fish", \
  minecraft:unbreakable={}, \
...
give @s minecraft:carrot_on_a_stick[ \
  ...
  minecraft:item_model="dvz:mana_steal", \
  minecraft:unbreakable={}, \
...
give @s minecraft:carrot_on_a_stick[ \
  ...
  minecraft:item_model="dvz:disarm", \
  minecraft:unbreakable={}, \
