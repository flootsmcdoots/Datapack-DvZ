...
tag @s add dvz.zombie.class.phantom

# Decreases max health by 2 hearts using an attribute.
attribute @s minecraft:max_health modifier add dvz:phantom.max_health -4 add_value
...
item replace entity @s armor.head with minecraft:leather_helmet[ \
  ...
  minecraft:item_model="dvz:phantom_head", \
...
item replace entity @s armor.chest with minecraft:leather_chestplate[ \
  ...
  minecraft:equippable={asset_id:"dvz:phantom_wings",slot:"chest"}, \
  minecraft:glider={}, \
  minecraft:tooltip_display={ \
    hidden_components:[ \
...
give @s minecraft:music_disc_cat[ \
  ...
  minecraft:item_model="dvz:iron_rapier", \
  minecraft:enchantments={"dvz:impact":1,"minecraft:knockback":2}, \
...
give @s minecraft:carrot_on_a_stick[ \
  ...
  minecraft:item_model="dvz:delirium", \
  minecraft:unbreakable={}, \
