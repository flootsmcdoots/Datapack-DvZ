...
# Toggle the ability.
item modify entity @s[tag=temp.use.mainhand,tag=temp.enabled] weapon.mainhand dvz:flutter_disable
item modify entity @s[tag=temp.use.mainhand,tag=!temp.enabled] weapon.mainhand dvz:flutter_enable
item modify entity @s[tag=temp.use.offhand,tag=temp.enabled] weapon.offhand dvz:flutter_disable
item modify entity @s[tag=temp.use.offhand,tag=!temp.enabled] weapon.offhand dvz:flutter_enable
