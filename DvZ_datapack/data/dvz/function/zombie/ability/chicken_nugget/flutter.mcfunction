...
effect give @s[predicate=!dvz:input_sneak_pressed] minecraft:slow_falling infinite 0 true

# Clear the slow falling effect if the player is holding down the sneak button.
effect clear @s[predicate=dvz:input_sneak_pressed] minecraft:slow_falling
