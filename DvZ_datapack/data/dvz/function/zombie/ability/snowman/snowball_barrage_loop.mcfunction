...
tag @n[type=minecraft:area_effect_cloud,tag=temp.processing] add dvz.projectile.snowball_barrage
...
execute as @s[scores={temp.snowball_amount=1..}] at @s run function dvz:zombie/ability/snowman/snowball_barrage_loop
