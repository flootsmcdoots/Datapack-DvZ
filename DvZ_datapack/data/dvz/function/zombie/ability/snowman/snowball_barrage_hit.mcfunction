...
execute positioned ~-1.3 ~-2.5 ~-1.3 as @a[dx=1.0,dy=1.6,dz=1.0] run damage @s[tag=dvz.dwarf] 12 dvz:snowball by @p[tag=temp.origin]
execute positioned ~-1.3 ~-2.5 ~-1.3 as @a[dx=1.0,dy=1.6,dz=1.0] run damage @s[tag=dvz.zombie] 1.2 dvz:snowball by @p[tag=temp.origin]
