...
item modify entity @s[tag=temp.use.mainhand] weapon.mainhand dvz:slapper_fish_charge
item modify entity @s[tag=temp.use.offhand] weapon.offhand dvz:slapper_fish_charge
