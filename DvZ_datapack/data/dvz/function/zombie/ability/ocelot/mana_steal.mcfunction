...
execute if entity @s[scores={dvz.ocelot.mana_steal.cooldown.seconds=1..}] run title @s actionbar [ \
  "", \
  {text:"[Mana Steal]",bold:true,color:"red"}, \
  {text:" You have ",color:"red"}, \
  {"score":{"name":"@s","objective":"dvz.ocelot.mana_steal.cooldown.seconds"},bold:true,color:"red"}, \
  {text:" seconds remaining!",color:"red"} \
]
execute if entity @s[scores={dvz.ocelot.mana_steal.cooldown.seconds=1..}] run return 0

# Set the cooldown.
scoreboard players set @s dvz.ocelot.mana_steal.cooldown.seconds 10
...
execute as @n[type=minecraft:marker,tag=temp.ray] at @s run function dvz:zombie/ability/ocelot/mana_steal_loop

# Create a temporary scoreboard to save the targeted player's current mana
scoreboard objectives add temp.mana dummy
execute store result score @s temp.mana run experience query @p[tag=temp.hit,tag=dvz.mana] levels
...
execute as @s[scores={temp.mana=1..}] as @p[tag=temp.hit,tag=dvz.mana] at @s run playsound minecraft:block.beacon.deactivate player @s ~ ~ ~ 1 1 1
execute as @s[scores={temp.mana=1..}] run title @p[tag=temp.hit,tag=dvz.mana] actionbar [ \
  "", \
...
execute as @s[scores={temp.mana=1..}] run scoreboard players operation @p[tag=temp.hit,tag=dvz.mana] dvz.dwarf.mana_buildup.mana -= @s temp.mana
execute as @s[scores={temp.mana=1..}] run scoreboard players operation @s dvz.dwarf.mana_buildup.mana += @s temp.mana
...
#execute as @s[scores={temp.mana=16..}] run scoreboard players add @s dvz.dwarf.mana_buildup.mana 16
#execute as @s[scores={temp.mana=16..}] run scoreboard players remove @p[tag=temp.hit,tag=dvz.mana] dvz.dwarf.mana_buildup.mana 16
#execute as @s[scores={temp.mana=16..}] run scoreboard players remove @s temp.mana 16
#execute as @s[scores={temp.mana=8..}] run scoreboard players add @s dvz.dwarf.mana_buildup.mana 8
#execute as @s[scores={temp.mana=8..}] run scoreboard players remove @p[tag=temp.hit,tag=dvz.mana] dvz.dwarf.mana_buildup.mana 8
#execute as @s[scores={temp.mana=8..}] run scoreboard players remove @s temp.mana 8
#execute as @s[scores={temp.mana=4..}] run scoreboard players add @s dvz.dwarf.mana_buildup.mana 4
#execute as @s[scores={temp.mana=4..}] run scoreboard players remove @p[tag=temp.hit,tag=dvz.mana] dvz.dwarf.mana_buildup.mana 4
#execute as @s[scores={temp.mana=4..}] run scoreboard players remove @s temp.mana 4
#execute as @s[scores={temp.mana=2..}] run scoreboard players add @s dvz.dwarf.mana_buildup.mana 2
#execute as @s[scores={temp.mana=2..}] run scoreboard players remove @p[tag=temp.hit,tag=dvz.mana] dvz.dwarf.mana_buildup.mana 2
#execute as @s[scores={temp.mana=2..}] run scoreboard players remove @s temp.mana 2
#execute as @s[scores={temp.mana=1..}] run scoreboard players add @s dvz.dwarf.mana_buildup.mana 1
#execute as @s[scores={temp.mana=1..}] run scoreboard players remove @p[tag=temp.hit,tag=dvz.mana] dvz.dwarf.mana_buildup.mana 1
