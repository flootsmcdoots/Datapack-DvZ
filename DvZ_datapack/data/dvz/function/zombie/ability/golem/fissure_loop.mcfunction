...
execute at @s unless block ~ ~ ~ #dvz:go_through run tp @s ~ ~1 ~
execute at @s unless block ~ ~ ~ #dvz:go_through run tp @s ~ ~1 ~

# Go down 1 or 2 blocks if there is no solid blocks below the ray marker.
execute at @s if block ~ ~-1 ~ #dvz:go_through run tp @s ~ ~-1 ~
execute at @s if block ~ ~-1 ~ #dvz:go_through run tp @s ~ ~-1 ~
...
execute at @s positioned ~ ~0 ~ if block ~ ~ ~ #dvz:go_through run function dvz:zombie/ability/golem/fissure_raise
execute at @s positioned ~ ~1 ~ if block ~ ~ ~ #dvz:go_through run function dvz:zombie/ability/golem/fissure_raise
execute at @s positioned ~ ~2 ~ if block ~ ~ ~ #dvz:go_through run function dvz:zombie/ability/golem/fissure_raise
...
execute as @s at @s run function dvz:zombie/ability/golem/fissure_search

# Repeat the raycasting loop.
execute as @s at @s run function dvz:zombie/ability/golem/fissure_loop
