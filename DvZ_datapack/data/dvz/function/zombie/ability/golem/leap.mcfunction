...
execute unless predicate dvz:is_on_ground run return 0

# Display a fail message and return if the ability is on a cooldown.
execute if entity @s[scores={dvz.golem.leap.cooldown.seconds=1..}] run title @s actionbar [ \
  "", \
  {text:"[Leap]",bold:true,color:"red"}, \
  {text:" You have ",color:"red"}, \
  {"score":{"name":"@s","objective":"dvz.golem.leap.cooldown.seconds"},bold:true,color:"red"}, \
  {text:" seconds remaining!",color:"red"} \
]
execute if entity @s[scores={dvz.golem.leap.cooldown.seconds=1..}] run return 0

# Set the cooldown.
scoreboard players set @s dvz.golem.leap.cooldown.seconds 20
...
attribute @s minecraft:explosion_knockback_resistance modifier add dvz:temp.remove.explosion_knockback_resistance -1 add_multiplied_total
...
attribute @s minecraft:explosion_knockback_resistance modifier remove dvz:temp.remove.explosion_knockback_resistance
