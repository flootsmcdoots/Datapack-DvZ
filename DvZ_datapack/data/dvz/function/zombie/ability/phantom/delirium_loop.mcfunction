#> Description: Raycasting loop for delirium.
...
execute if entity @p[tag=temp.ray_origin,distance=4..] run particle minecraft:squid_ink ~ ~ ~ 0.05 0.05 0.05 0 1 force
...
execute as @s at @s run function dvz:zombie/ability/phantom/delirium_loop
