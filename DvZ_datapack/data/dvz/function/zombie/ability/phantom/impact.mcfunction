...
execute on attacker run data modify storage dvz:vector xyz set from entity @s Motion
...
execute as @s[scores={temp.velocity=2000..}] store result storage dvz:damage amount float 1 run scoreboard players get @s temp.damage
execute as @s[scores={temp.velocity=2000..}] run function dvz:macro/damage_bonus with storage dvz:damage
...
execute store result storage dvz:damage amount float 0.1 run scoreboard players get @s temp.damage
function dvz:macro/damage_bonus with storage dvz:damage
