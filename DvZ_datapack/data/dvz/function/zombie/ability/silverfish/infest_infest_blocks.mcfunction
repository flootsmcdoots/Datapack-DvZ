...
scoreboard players remove @s dvz.silverfish.silverfish_egg.count 1
...
tag @n[type=minecraft:marker,tag=temp.processing] add dvz.infestation
tag @n[type=minecraft:marker,tag=temp.processing] add dvz.kill_on_reload
...
# Front blocks
execute at @n[type=minecraft:marker,tag=temp.processing] positioned ^ ^1 ^1 if block ~ ~ ~ #dvz:dwarf_blocks if block ^ ^ ^1 #dvz:go_through run setblock ~ ~ ~ minecraft:infested_stone
execute at @n[type=minecraft:marker,tag=temp.processing] positioned ^1 ^1 ^1 if block ~ ~ ~ #dvz:dwarf_blocks if block ^ ^ ^1 #dvz:go_through run setblock ~ ~ ~ minecraft:infested_stone
execute at @n[type=minecraft:marker,tag=temp.processing] positioned ^1 ^ ^1 if block ~ ~ ~ #dvz:dwarf_blocks if block ^ ^ ^1 #dvz:go_through run setblock ~ ~ ~ minecraft:infested_stone
execute at @n[type=minecraft:marker,tag=temp.processing] positioned ^1 ^-1 ^1 if block ~ ~ ~ #dvz:dwarf_blocks if block ^ ^ ^1 #dvz:go_through run setblock ~ ~ ~ minecraft:infested_stone
execute at @n[type=minecraft:marker,tag=temp.processing] positioned ^ ^-1 ^1 if block ~ ~ ~ #dvz:dwarf_blocks if block ^ ^ ^1 #dvz:go_through run setblock ~ ~ ~ minecraft:infested_stone
execute at @n[type=minecraft:marker,tag=temp.processing] positioned ^-1 ^-1 ^1 if block ~ ~ ~ #dvz:dwarf_blocks if block ^ ^ ^1 #dvz:go_through run setblock ~ ~ ~ minecraft:infested_stone
...
execute at @n[type=minecraft:marker,tag=temp.processing] positioned ^ ^1 ^ if block ~ ~ ~ #dvz:dwarf_blocks if block ^ ^ ^1 #dvz:go_through run setblock ~ ~ ~ minecraft:infested_stone
execute at @n[type=minecraft:marker,tag=temp.processing] positioned ^1 ^1 ^ if block ~ ~ ~ #dvz:dwarf_blocks if block ^ ^ ^1 #dvz:go_through run setblock ~ ~ ~ minecraft:infested_stone
execute at @n[type=minecraft:marker,tag=temp.processing] positioned ^1 ^ ^ if block ~ ~ ~ #dvz:dwarf_blocks if block ^ ^ ^1 #dvz:go_through run setblock ~ ~ ~ minecraft:infested_stone
execute at @n[type=minecraft:marker,tag=temp.processing] positioned ^1 ^-1 ^ if block ~ ~ ~ #dvz:dwarf_blocks if block ^ ^ ^1 #dvz:go_through run setblock ~ ~ ~ minecraft:infested_stone
execute at @n[type=minecraft:marker,tag=temp.processing] positioned ^ ^-1 ^ if block ~ ~ ~ #dvz:dwarf_blocks if block ^ ^ ^1 #dvz:go_through run setblock ~ ~ ~ minecraft:infested_stone
...
# Back blocks
execute at @n[type=minecraft:marker,tag=temp.processing] positioned ^ ^1 ^-1 if block ~ ~ ~ #dvz:dwarf_blocks if block ^ ^ ^1 #dvz:go_through if block ^ ^ ^2 #dvz:go_through run setblock ~ ~ ~ minecraft:infested_stone
execute at @n[type=minecraft:marker,tag=temp.processing] positioned ^1 ^1 ^-1 if block ~ ~ ~ #dvz:dwarf_blocks if block ^ ^ ^1 #dvz:go_through if block ^ ^ ^2 #dvz:go_through run setblock ~ ~ ~ minecraft:infested_stone
execute at @n[type=minecraft:marker,tag=temp.processing] positioned ^1 ^ ^-1 if block ~ ~ ~ #dvz:dwarf_blocks if block ^ ^ ^1 #dvz:go_through if block ^ ^ ^2 #dvz:go_through run setblock ~ ~ ~ minecraft:infested_stone
execute at @n[type=minecraft:marker,tag=temp.processing] positioned ^1 ^-1 ^-1 if block ~ ~ ~ #dvz:dwarf_blocks if block ^ ^ ^1 #dvz:go_through if block ^ ^ ^2 #dvz:go_through run setblock ~ ~ ~ minecraft:infested_stone
execute at @n[type=minecraft:marker,tag=temp.processing] positioned ^ ^-1 ^-1 if block ~ ~ ~ #dvz:dwarf_blocks if block ^ ^ ^1 #dvz:go_through if block ^ ^ ^2 #dvz:go_through run setblock ~ ~ ~ minecraft:infested_stone
execute at @n[type=minecraft:marker,tag=temp.processing] positioned ^-1 ^-1 ^-1 if block ~ ~ ~ #dvz:dwarf_blocks if block ^ ^ ^1 #dvz:go_through if block ^ ^ ^2 #dvz:go_through run setblock ~ ~ ~ minecraft:infested_stone
