...
execute unless block ~ ~ ~ #dvz:go_through unless block ~ ~ ~ minecraft:packed_ice run return 0
...
execute as @s at @s run function dvz:zombie/ability/chillager/ice_bridge_loop
