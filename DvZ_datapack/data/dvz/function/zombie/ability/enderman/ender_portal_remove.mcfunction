...
fill ~-5 ~-3 ~-5 ~5 ~-1 ~5 minecraft:air replace #dvz:ender_portal_blocks
...
execute unless entity @e[type=minecraft:marker,tag=dvz.marker.ender_portal] run clear @a[gamemode=!creative,gamemode=!spectator] minecraft:carrot_on_a_stick[minecraft:custom_data~{active_id:9001}]
