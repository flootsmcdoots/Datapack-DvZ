...
execute at @n[type=minecraft:marker,tag=temp.ray] positioned ^ ^ ^1 unless block ~ ~-1 ~ #dvz:go_through if block ~ ~ ~ #dvz:go_through if block ~ ~1 ~ #dvz:go_through run return run summon minecraft:marker ~ ~ ~ {Tags:["temp.teleport"]}

# On top of the hit block.
execute at @n[type=minecraft:marker,tag=temp.ray] positioned ~ ~1 ~ unless block ~ ~-1 ~ #dvz:go_through if block ~ ~ ~ #dvz:go_through if block ~ ~1 ~ #dvz:go_through run return run summon minecraft:marker ~ ~ ~ {Tags:["temp.teleport"]}

# On top of the block above the hit block.
execute at @n[type=minecraft:marker,tag=temp.ray] positioned ~ ~2 ~ unless block ~ ~-1 ~ #dvz:go_through if block ~ ~ ~ #dvz:go_through if block ~ ~1 ~ #dvz:go_through run return run summon minecraft:marker ~ ~ ~ {Tags:["temp.teleport"]}

# On top of the block 2 blocks above the hit block.
execute at @n[type=minecraft:marker,tag=temp.ray] positioned ~ ~3 ~ unless block ~ ~-1 ~ #dvz:go_through if block ~ ~ ~ #dvz:go_through if block ~ ~1 ~ #dvz:go_through run return run summon minecraft:marker ~ ~ ~ {Tags:["temp.teleport"]}
