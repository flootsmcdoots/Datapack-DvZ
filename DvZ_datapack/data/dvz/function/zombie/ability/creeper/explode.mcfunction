...
execute if entity @e[type=minecraft:marker,tag=dvz.marker.ender_portal,distance=..8] run title @s actionbar [ \
  "", \
  {text:"[Explode]",bold:true,color:"red"}, \
...
execute as @s[tag=dvz.zombie.punish] if entity @a[tag=dvz.dwarf,distance=..6] run tag @s remove dvz.zombie.punish
execute as @s[tag=dvz.zombie.punish] if block ~ ~-1 ~ #dvz:dwarf_blocks run tag @s remove dvz.zombie.punish
execute as @s[tag=dvz.zombie.punish] if block ~1 ~ ~ #dvz:dwarf_blocks run tag @s remove dvz.zombie.punish
execute as @s[tag=dvz.zombie.punish] if block ~-1 ~ ~ #dvz:dwarf_blocks run tag @s remove dvz.zombie.punish
execute as @s[tag=dvz.zombie.punish] if block ~ ~ ~1 #dvz:dwarf_blocks run tag @s remove dvz.zombie.punish
execute as @s[tag=dvz.zombie.punish] if block ~ ~ ~-1 #dvz:dwarf_blocks run tag @s remove dvz.zombie.punish
execute as @s[tag=dvz.zombie.punish] if block ~1 ~1 ~ #dvz:dwarf_blocks run tag @s remove dvz.zombie.punish
execute as @s[tag=dvz.zombie.punish] if block ~-1 ~1 ~ #dvz:dwarf_blocks run tag @s remove dvz.zombie.punish
execute as @s[tag=dvz.zombie.punish] if block ~ ~1 ~1 #dvz:dwarf_blocks run tag @s remove dvz.zombie.punish
execute as @s[tag=dvz.zombie.punish] if block ~ ~1 ~-1 #dvz:dwarf_blocks run tag @s remove dvz.zombie.punish
execute as @s[tag=dvz.zombie.punish] if block ~ ~2 ~ #dvz:dwarf_blocks run tag @s remove dvz.zombie.punish

# Clear dwarf blocks (except reinforced bricks) around the player to promote blowing up keep walls.
fill ~ ~ ~-1 ~ ~1 ~1 minecraft:air replace #dvz:dwarf_blocks
fill ~-1 ~ ~ ~1 ~1 ~ minecraft:air replace #dvz:dwarf_blocks
