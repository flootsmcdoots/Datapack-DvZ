...
tag @s[tag=dvz.marked_for_death] add temp.marked_for_death

# Toggle the marked for death tag.
tag @s[tag=!temp.marked_for_death] add dvz.marked_for_death
tag @s[tag=temp.marked_for_death] remove dvz.marked_for_death
