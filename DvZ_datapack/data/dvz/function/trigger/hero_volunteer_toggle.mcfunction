...
tag @s[tag=dvz.hero_default] add temp.hero_default
tag @s[tag=dvz.hero_volunteer] add temp.hero_volunteer
tag @s[tag=dvz.hero_opt_out] add temp.hero_opt_out

# If the player was neutral (default state) have them volunteer for hero
tag @s[tag=temp.hero_default] add dvz.hero_volunteer
tag @s[tag=temp.hero_default] remove dvz.hero_default
...
tag @s[tag=temp.hero_volunteer] add dvz.hero_opt_out
tag @s[tag=temp.hero_volunteer] remove dvz.hero_volunteer
...
tag @s[tag=temp.hero_opt_out] add dvz.hero_default
tag @s[tag=temp.hero_opt_out] remove dvz.hero_opt_out
