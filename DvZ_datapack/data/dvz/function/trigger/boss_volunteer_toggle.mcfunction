...
tag @s[tag=dvz.boss_volunteer] add temp.marked_for_death

# Toggle the volunteer tag.
tag @s[tag=!temp.marked_for_death] add dvz.boss_volunteer
tag @s[tag=temp.marked_for_death] remove dvz.boss_volunteer
