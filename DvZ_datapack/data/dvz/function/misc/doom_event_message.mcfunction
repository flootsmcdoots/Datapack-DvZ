...
execute if score &dvz dvz.game.boss matches 1 run tellraw @s [ \
  "", \
  {text:"\u1120\u1121\u1122\n",font:"dvz:custom"}, \
...
execute if score &dvz dvz.game.boss matches 2 run tellraw @s [ \
  "", \
  {text:"\u1120\u1121\u1122\n",font:"dvz:custom"}, \
  {text:"▶ ",bold:true,color:"light_purple"}, \
  {text:"The doom event is: ",color:"light_purple"}, \
...
execute if score &dvz dvz.game.boss matches 3 run tellraw @s [ \
  "", \
  {text:"\u1120\u1121\u1122\n",font:"dvz:custom"}, \
  {text:"▶ ",bold:true,color:"light_purple"}, \
  {text:"The doom event is: ",color:"light_purple"}, \
...
execute if score &dvz dvz.game.boss matches 4 run tellraw @s [ \
  "", \
  {text:"\u1120\u1121\u1122\n",font:"dvz:custom"}, \
  {text:"▶ ",bold:true,color:"light_purple"}, \
  {text:"The doom event is: ",color:"light_purple"}, \
