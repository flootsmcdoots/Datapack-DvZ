...
execute if score &dvz dvz.game.phase matches 0 run return 0
...
execute if score &dvz dvz.game.phase matches 1 run function dvz:dwarf/spawn
execute if score &dvz dvz.game.phase matches 2..6 run function dvz:zombie/spawn
