...
scoreboard players set &dvz dvz.game.phase 5
...
tag @a[tag=dvz.dwarf] add dvz.dwarf.last_dwarf
effect give @a[tag=dvz.dwarf] minecraft:instant_health 1 5 true
effect give @a[tag=dvz.dwarf] minecraft:saturation 1 20 true
