...
execute as @s if score &dvz dvz.game.phase matches 0 run tellraw @s [ \
  "", \
  {text:"\u1110\u1111\u1112\n",font:"dvz:custom"}, \
...
execute as @s if score &dvz dvz.game.phase matches 1..5 run tellraw @s [ \
  "", \
  {text:"\u1110\u1111\u1112\n",font:"dvz:custom"}, \
  {text:"▶ ",bold:true,color:"gold"}, \
...
execute if score &dvz dvz.game.phase matches 6 run tellraw @s [ \
  "", \
  {text:"\u1110\u1111\u1112\n",font:"dvz:custom"}, \
  {text:"▶ ",bold:true,color:"gold"}, \
