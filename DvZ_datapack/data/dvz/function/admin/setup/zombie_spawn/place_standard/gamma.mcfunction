#> Description: Place the standard zombie spawn gamma.
...
# Summon a zombie spawn gamma marker.
...
# Summon a zombie spawn gamma seat marker.
...
# Summon a zombie spawn gamma display marker.
...
# Summon a zombie spawn gamma text marker.
